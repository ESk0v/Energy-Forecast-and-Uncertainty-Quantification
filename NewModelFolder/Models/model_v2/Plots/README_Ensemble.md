...
Auto-generated by `EnsembleOutput.py` on 2026-03-05 13:27:51.
...
## `week_forecast_ensemble_week2.png` — Weekly Forecast with Uncertainty
...
### `residuals_ensemble.png` — Residuals Over Time
...
### `uncertainty_histogram.png` — Uncertainty Distribution
...
### `prediction_vs_actual.png` — Predicted vs Actual Scatter
...
### `uncertainty_vs_error.png` — Uncertainty vs Error
