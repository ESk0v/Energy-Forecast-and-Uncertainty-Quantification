...
Instead of training a single LSTM model, the ensemble trains **2 independent
...
|---|---|---|
| **Epistemic** | Disagreement between the 2 models | What the model *doesn't know* — reduces with more data/training |
...
- **Predicted mean** (solid line) — the ensemble average across all 2 models
...
- The ensemble was trained with **GaussianNLLLoss**, so each model outputs both a
  ...
  output; epistemic uncertainty comes from disagreement between the 2 models.
