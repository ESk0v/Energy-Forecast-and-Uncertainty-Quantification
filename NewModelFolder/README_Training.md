...
Auto-generated by `LSTMTraining.py` on 2026-03-05 14:07:05.
...
| Best validation loss (GaussianNLL) | 0.875024 |
| Total epochs run | 1 |
...
|---|---|---|
| Train | 13766 | 344150.0% |
| Validation | 1720 | 43000.0% |
| Test | 44 | 1100.0% |
| **Total** | **4** | **100%** |

The split is **chronological** — no data leakage. The test set is always the most
recent 1100.0% of the data and is never touched during training.
